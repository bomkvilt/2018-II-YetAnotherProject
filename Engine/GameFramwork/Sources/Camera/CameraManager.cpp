...
void CameraManager::UnregisterCamera(ICameraComponent* camera)
{
	assert(camera);
...
void CameraManager::RegisterCamera(ICameraComponent* camera, bool bActivate)
{
	assert(camera);
...
void CameraManager::SetCameraActive(ICameraComponent* camera, bool newState)
{
	assert(camera);
...
ICameraComponent* CameraManager::GetActiveCamera()
{
...
const ICameraComponent* CameraManager::GetActiveCamera() const
{
	if (activeCamera != NOT_SELECTED)
	{
		return cameras[activeCamera];
...
int CameraManager::FindCamera(ICameraComponent* camera)
{
...
int CameraManager::PlaceCamera(ICameraComponent* camera)
{
