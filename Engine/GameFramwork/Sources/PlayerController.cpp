...
void PlayerController::UnregisterCamera(ICameraComponent* camera)                 { cameraManager.UnregisterCamera(camera); }
void PlayerController::RegisterCamera  (ICameraComponent* camera, bool bActivate) { cameraManager.RegisterCamera (camera, bActivate); }
void PlayerController::SetCameraActive (ICameraComponent* camera, bool newState)  { cameraManager.SetCameraActive(camera, newState);  }

      ICameraComponent* PlayerController::GetActiveCamera()       { return cameraManager.GetActiveCamera(); }
const ICameraComponent* PlayerController::GetActiveCamera() const { return cameraManager.GetActiveCamera(); }
